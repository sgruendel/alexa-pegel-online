...
const event = {
    ...
    request: {
        ...
        locale: 'de-DE',
        timestamp: '2017-04-04T07:52:30Z',
        intent: {
...
describe('Testing a session with the WaterLevelIntent for Bodensee:', () => {
    ...
    describe('The response', () => {
        ...
        it('should have a standard card response', () => {
            ...
            expect(speechResponse.response.card.title).contains('Konstanz');
